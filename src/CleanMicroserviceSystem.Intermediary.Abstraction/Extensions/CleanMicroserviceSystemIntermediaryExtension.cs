using CleanMicroserviceSystem.Intermediary.Abstraction.Application;

namespace CleanMicroserviceSystem.Intermediary.Abstraction.Extensions;

public static class CleanMicroserviceSystemIntermediaryHandlerExtension
{
