...
namespace CleanMicroserviceSystem.Themis.Infrastructure.Migrations.ConfigurationDb
{
    ...
    [Migration("20230726070727_InitializeThemisNTLMClient")]
    partial class InitializeThemisNTLMClient
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleanMicroserviceSystem.Themis.Domain.Entities.Configuration.ApiResource", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2023, 7, 26, 7, 7, 27, 133, DateTimeKind.Utc).AddTicks(2484),
            ...
            modelBuilder.Entity("CleanMicroserviceSystem.Themis.Domain.Entities.Configuration.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2023, 7, 26, 7, 7, 27, 133, DateTimeKind.Utc).AddTicks(2547),
                            Description = "Tethys",
                            Enabled = true,
                            Name = "Tethys",
