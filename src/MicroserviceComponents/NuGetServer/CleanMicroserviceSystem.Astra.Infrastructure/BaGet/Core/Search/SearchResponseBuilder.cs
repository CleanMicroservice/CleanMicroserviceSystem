    ...
    public SearchResponse BuildSearch(IReadOnlyList<PackageRegistration> packageRegistrations)
    {
        ...
        foreach (var packageRegistration in packageRegistrations)
        {
            ...
            var iconUrl = latest.HasEmbeddedIcon
                ? this._url.GetPackageIconDownloadUrl(latest.Id, latest.Version)
            ...
            result.Add(new SearchResult
            {
                ...
                RegistrationIndexUrl = this._url.GetRegistrationIndexUrl(latest.Id),
        ...
        return new SearchResponse
        {
            ...
            Data = result,
            Context = SearchContext.Default(this._url.GetPackageMetadataResourceUrl()),
        };
    }
