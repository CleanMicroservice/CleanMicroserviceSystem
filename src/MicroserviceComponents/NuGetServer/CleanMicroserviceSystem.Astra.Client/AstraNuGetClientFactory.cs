...
using CleanMicroserviceSystem.Astra.Client.PackageContent;
using CleanMicroserviceSystem.Astra.Client.PackageMetadata;
using CleanMicroserviceSystem.Astra.Client.Search;
using CleanMicroserviceSystem.Astra.Client.ServiceIndex;
...
public partial class AstraNuGetClientFactory
{
    ...
    protected AstraNuGetClientFactory()
    {
    }

    public AstraNuGetClientFactory(HttpClient httpClient, string serviceIndexUrl)
    {
