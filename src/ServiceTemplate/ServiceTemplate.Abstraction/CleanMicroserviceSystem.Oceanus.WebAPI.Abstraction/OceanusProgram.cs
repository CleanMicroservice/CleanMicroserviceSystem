...
public class OceanusProgram
{
	...
	public virtual void ConfigurePipelines()
	{
		...
		ConfigurePipelinesBeforeAuthorization();
		webApp.UseAuthorization();
		ConfigurePipelinesAfterAuthorization();
		webApp.MapControllers();
	}

	public virtual void ConfigurePipelinesBeforeAuthorization()
	{
	}

	public virtual void ConfigurePipelinesAfterAuthorization()
	{
	}
